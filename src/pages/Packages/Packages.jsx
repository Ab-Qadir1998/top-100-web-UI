						...
						<div className="row">
							<div className="col-md-6 wow animate__animated animate__fadeInLeft animate__delay-1s">
								<div className="text-here py-5 pe-xl-3">
									...
									<p className="para me-xl-3">
										We offer you our HTML Package, available for a one-time fee
							...
							<div className="col-md-6 px-lg-5 wow animate__animated animate__fadeInRight animate__delay-2s">
								<div class="small-business-div">
									<h3 class="level-3">
										Small <span class="text-primary">Business</span> Website
									</h3>
									<h4 class="level-5">
									...
									<Link to="/checkout" class="btn w-100 primary-btn  ">
										Place Order
									</Link>
								</div>
							</div>
						...
						<div className="row">
							<div className="col-lg-5 ps-xxl-4 pe-xxl-5">
								<div className="text-here">
									<h6 className="level-5 text-primary m-0 ">
										Do you want a free analysis of your website?
									</h6>
											...
											<div className="col-md-4 mb-3">
												<label className="form-label w-100 m-0">
													...
													>
														...
														<option value="Website Advertising">
															Website Advertising
														</option>
														<option value="Website Marketing">
															Website Marketing
														</option>
														<option value="Internet Advertising">
															Internet Advertising
														</option>
														<option value="Website Digital Advertising">
