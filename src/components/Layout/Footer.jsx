						...
						<div className="row">
							<div className="col-lg-4 col-md-6 ">
								<div className="footer-content logo-content">
									...
									<p>
										At Top 100 Website Advertising, we're your dedicated partner
										in achieving online success through expert SEO services.
									</p>
								</div>
							</div>
							<div className="col-lg-4 col-md-6 ">
								<div className="footer-content">
									<ul className="menu-links menus quick-links">
										{footerLinks?.map((fooLinks, i) => (
											<li key={i}>
												<Link to={fooLinks?.link} className=" text-uppercase">
													{fooLinks?.label}
												</Link>
											</li>
										))}
