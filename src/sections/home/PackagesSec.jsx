			...
			<div className="container">
				<div className="row ">
					<div className="col-lg-6 col-md-6 pe-lg-5 customized-quote-div wow animate__animated animate__fadeInLeft animate__delay-1s">
						...
						<p className="para me-xl-3">
							We offer the HTML Package for a one-time fee of $500. Your
							webmaster will seamlessly integrate this package into your
							website. Following integration, our team at Top 100 Website
							Advertising initiates your business's advertising campaign, priced
							at $250.00 per month. Should you, as the website business owner,
							you ever find our performance unsatisfactory, there's no
					...
					<div className="col-xl-5 col-lg-6 col-md-6 ps-lg-5 wow animate__animated animate__fadeInRight animate__delay-2s">
						<div className="small-business-div">
							...
							<h4 className="level-4">
								$500 HTML Package (one time fee), then $250 a month
							</h4>
                ...
                <p className="para">
                  ...
                  cursus euismod.
							...
							<div className="row">
								...
								<Link to="/checkout" className={`btn  primary-btn w-100`}>
									Place Order
								</Link>
