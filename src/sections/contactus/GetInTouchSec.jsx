						...
						<div className="row">
							<div className="col-md-7 pe-lg-5 wow animate__animated animate__fadeInLeft animate__delay-1s">
								<div className="countact-text pe-xxl-5">
									...
									<h2 class="level-1 line-height-1 text-primary">
